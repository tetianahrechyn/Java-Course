...
const OperatorsTheory = () => {
    const [theories, setTheories] = useState([]);

    useEffect(() => {
        const fetchTheories = async () => {
            try {
                const querySnapshot = await getDocs(collection(db, 'thoperators'));
    ...
    return (
        <div style={{ width: '100%', height: '100%', position: 'relative', background: '#F4F2F6' }}>
            <div style={{ width: 1440, height: 934, position: 'absolute', left: 0, top: 94 }}>
                <div style={{ width: 1440, height: 4170, background: '#F4F2F6' }} />
                <div style={{ width: 580, height: 393, position: 'absolute', left: 92, top: 217 }}>
                </div>
                <div style={{ marginLeft: '5cm', marginRight: '5cm', marginTop: '-4140px', position: 'relative', zIndex: 10 }}>
                ...
                <div style={{ width: 1440, height: 385, background: 'white', position: 'absolute', left: 0, top: 4260 }} />
                <div style={{
                    color: '#150E06',
                    fontSize: 16,
                    fontFamily: 'Raleway',
            ...
            <div style={{ width: '100%', height: '100%', position: 'relative', top: 4270 }}>
                <Link to="/about" style={{
                    position: 'absolute',
                    left: 745,
                    top: 45,
...
export default OperatorsTheory;
