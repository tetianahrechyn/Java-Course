...
const HelloWorld = () => {
    ...
    useEffect(() => {
        ...
        if (user) {
            ...
            const testResultsRef = ref(database, 'testResultshelloworld/' + userId);
    ...
    return (
        <div style={{ width: '100%', height: '100%', position: 'relative', background: '#F4F2F6' }}>
            <div style={{ width: 1440, height: 934, position: 'absolute', left: 0, top: 94 }}>
                ...
                <Link to="/helloworldtheory" style={{
                    color: '#007ACC',
                    fontSize: 20,
                ...
                <Link to="/helloworldplustheory" style={{
                    color: '#007ACC',
                    fontSize: 20,
                    fontFamily: 'Raleway, sans-serif', // Виправлено шрифт
                    fontWeight: 700,
